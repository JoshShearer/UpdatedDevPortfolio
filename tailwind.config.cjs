  ...
  theme: {
    ...
    colors: {
      light: {
        ...
        onPrimary: '#FFFFFF',          // Contrasting white for text/icons
        primaryContainer: '#D9EBFF',   // Soft blue container
        onPrimaryContainer: '#002B4D', // Darker blue for contrasts
        secondary: '#50E3C2',          // Vibrant teal for secondary actions
        onSecondary: '#00322B',        // Contrasting dark greenish-blue
        secondaryContainer: '#CFFCEF', // Soft teal container
        onSecondaryContainer: '#002318',
        tertiary: '#F5A623',           // Vibrant orange for highlights
        onTertiary: '#3E2A00',
        tertiaryContainer: '#FFE0B3',
        onTertiaryContainer: '#3E2600',
        error: '#E94E77',              // Modern red for errors
        onError: '#FFFFFF',
        errorContainer: '#FFD9DF',
        onErrorContainer: '#490016',
        background: '#F9FAFB',         // Light neutral background
        onBackground: '#20232A',       // Almost-black for contrast
        surface: '#FFFFFF',            // Clean white surface
        onSurface: '#374151',          // Neutral gray for text
        ...
        shadow: '#000000',
        scrim: '#000000',
        inverseSurface: '#20232A',
        inverseOnSurface: '#F9FAFB',
        inversePrimary: '#002B4D',
        elevation: {
          level0: 'transparent',
          level1: '#FAFBFC',
          level2: '#F4F6F8',
      ...
      dark: {
        primary: '#4A90E2',
        onPrimary: '#001B33',
        primaryContainer: '#002F57',
        onPrimaryContainer: '#D9EBFF',
        secondary: '#50E3C2',
        onSecondary: '#00271E',
        secondaryContainer: '#004033',
        onSecondaryContainer: '#CFFCEF',
        tertiary: '#F5A623',
        onTertiary: '#3E2A00',
        tertiaryContainer: '#5C3D00',
        onTertiaryContainer: '#FFE0B3',
        error: '#E94E77',
        onError: '#490016',
        errorContainer: '#93002E',
        ...
        shadow: '#000000',
        scrim: '#000000',
        inverseSurface: '#E4E7EB',
        inverseOnSurface: '#20232A',
        inversePrimary: '#D9EBFF',
        elevation: {
          level0: 'transparent',
          level1: '#24292F',
          level2: '#2C3139',
